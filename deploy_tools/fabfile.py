...
REPO_URL = 'http://github.com/simpen/mysuperlists.git'


def deploy():
    site_folder = '/home/%s/sites/%s' % (env.user, env.host)
    source_folder = site_folder + '/source'
    _create_directory_structure_if_necsssary(site_folder)
...
def _create_directory_structure_if_necsssary(site_folder):
